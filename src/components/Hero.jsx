...
const Hero = () => {
  return (
    <section className="relative w-full h-[calc(100vh-80px)] mx-auto mt-[80px]">
      <div
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Saludos, я <span className="text-[#915eff]">ShoxruX</span>
          </h1>
      ...
      <div className="absolute xs:bottom-5 bottom-10 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl border-4 border-secondary flex justify-center items-start p-1">
            <motion.div animate={{y: [0, 34, 0]}} transition={{duration: 1.5, repeat: Infinity, repeatType: 'loop'}} className="w-3 h-3 rounded-full bg-secondary mb-1" />
          </div>
        </a>
      </div>
    </section>
